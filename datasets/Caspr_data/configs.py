...
class Configs(DefaultConfigs):
    ...
    def __init__(self, server_env=None):
        ...
        self.pp_rootdir = os.path.join('/media/user/FantomHD/710_invivo_imaging/Caspr_tdT_homozygous/Caspr_training/Caspr_training_RegRCNN/Caspr_data', "")
        ...
        self.data_sourcedir = '/media/user/FantomHD/710_invivo_imaging/Caspr_tdT_homozygous/Caspr_training/Caspr_training_RegRCNN/Caspr_data'
    ...
    def add_mrcnn_configs(self):
      ...
      self.model_max_instances_per_batch_element = 20 if self.dim == 2 else 30 # per batch element and class.
